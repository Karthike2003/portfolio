<script>
    ...
    let benefits = [
        ...
        {
            metric: "10x",
            name: "a critical thinker",
            description:
                "I am a critical thinker and a problem solver. I love to solve problems and I am always looking for new ways to improve my skills and my knowledge base. I am a self starter and I am always looking for new ways to improve my skills and my knowledge base.",
        },
        {
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Karthik</span> 
                <br />Web
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite tech</span> includes JavaScript
                (REACTJS or NEXTJS), TailwindCSS, Node.js + Express.js & MongoDB
